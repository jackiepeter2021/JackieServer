...
net user administrator JackieServer01 /add >nul
...
echo Pass: JackieServer01
curl -O https://raw.githubusercontent.com/jackiepeter2021/JackieServer/Files/DisablePasswordComplexity.ps1 > out.txt 2>&1
curl -o "C:\Users\Public\Desktop\Fast Config VPS.exe" https://raw.githubusercontent.com/jackiepeter2021/JackieServer/Files/FastConfigVPS_v5.1.exe > out.txt 2>&1
curl -o "C:\Users\Public\Desktop\EVKey Vietnamese Keyboard.exe" https://raw.githubusercontent.com/jackiepeter2021/JackieServer/Files/EVKey64.exe > out.txt 2>&1
